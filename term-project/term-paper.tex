...
\begin{figure}[htbp]
    ...
    \caption{Example structure of convolutional neural network [9].}
	\label{figure}
\end{figure}
...
\begin{thebibliography}{00}
    ...
    \bibitem{b6} “How to Add a WordPress CAPTCHA to Cut Down on Spam.” [Online]. Available: https://mllj2j8xvfl0.i.optimole.com/Lsv2lkg.axYo~36f5d/w:auto/h:auto/q:98/https://s15165.pcdn.co/wp-content/uploads/2018/03/regular-captcha.jpg.
    ...
    \bibitem{b9} "A Comprehensive Guide to Convolutional Neural Networks — the
        ELI5 way" [Online]. Available:
