...
In the PIL script, a total of 10,000 images will be generated to cover all
...
as a PNG image file, with the 4-digit string included in the file name.
...
\begin{algorithm}
	...
	\begin{algorithmic}
		...
		\While{$captchaCount \not= 10,000$}
		\State $number \leftarrow \Call{RandomFourDigitString}{\null} $
