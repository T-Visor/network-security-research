...
CAPTCHA image. The pandas DataFrame will be used to store a pair of values
...
\begin{algorithm}[]
  ...
  \try{}{
    $fileName \leftarrow \Call{SplitFileName}{filePath} $

	$fileName \leftarrow \Call{SplitExtension}{fileName, ".png"} $

	$label \leftarrow \Call{Split}{fileName, "\_"} $
