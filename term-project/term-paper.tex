...
\begin{abstract}
    ...
    a neural network which is capable of over 99\% accuracy for certain datasets. 
...
libraries, and convolutional neural networks. The goal of this research is to
...
\begin{figure}[htbp]
    \centerline{\includegraphics{fgs-method.png}}
