...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale=0.7]{alphanumeric-captcha.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale=0.5]{grid-world.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale=0.5]{negative-kerning.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale=0.35]{fgsm_technique.png}}
...
creating a CAPTCHA-solving machine learning model. 

\subsection{Open-source Tool Selection}
\emph{Python 3} will be the programming language of choice, due to its
easy-to-use syntax, portability, and wide range of modules. 
...
Lastly, the code will be written for the \emph{Jupyter
