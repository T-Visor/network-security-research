...
Researchers at \hl{[19]} use the transfer learning technique to launch backdoor
attacks on a target machine learning model. The researchers had access to a
neural network structure which closely resembled the target. The attack
exploited the presence of extra neurons in the target model ... \hl{FINISH
THIS} 
