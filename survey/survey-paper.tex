...
The result is a \emph{neural network}, the mathematical model capable of making
...
\emph{classification}, where a dataset is categorized into different groups to
make observations and/or predictions of future data. There are several types of
classifications, including \emph{binary classification}, \emph{multi-class
classification}, \& \emph{multi-label classification}.
