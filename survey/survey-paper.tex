...
input data, learning mechanism of the machine learning model, and
classification behavior for its outputs.

\subsection{TODO: talk about mitigations for each. Mention encryption,
probability over discrete decision making, and auditing.}
