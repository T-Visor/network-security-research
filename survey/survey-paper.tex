...
A specialized approach to retraining with samples of malicious data is a technique called
\emph{adversarial retraining}. This process however, can be time-consuming due
to the need for a reasonable sample size with perturbations. The technique
involves labelling malicious data with perturbations as adversarial samples, and training
the model to detect them. This ensures that adversarial samples will not affect
