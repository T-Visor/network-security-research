...
Networks to aid in the detection of malicious data. In order to do this, a
...
model can then be used to generate labeled malicious data to help retrain a deployed
